 ...
 */
package com.k2data.k2app.quality.utils;
...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
     ...
     * 获取两个日期之间的天数
     */
    public static double getPassedDayBetweenDate(Date before, Date after) {
     ...
     * 获取两个日期之间的分钟数
     */
    public static double getPassedMinBetweenDate(Date before, Date after) {
        long beforeTime = before.getTime();
        long afterTime = after.getTime();
    ...
    public static String getDateByPlusDays(long daysToAdd) {
